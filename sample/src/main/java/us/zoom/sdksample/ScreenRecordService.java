...
public class ScreenRecordService extends Service {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            if (manager != null) {
                ...
                notification = new Notification.
                        Builder(getApplicationContext(), channelId).setOngoing(true).setSmallIcon(R.drawable.ic_launcher).setCategory(Notification.CATEGORY_SERVICE).build();
    ...
    private MediaRecorder createMediaRecorder() {
        ...
        mediaRecorder.setOutputFile(Environment.
                getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/" + videoQuality + curTime + ".mp4");
    ...
    private VirtualDisplay createVirtualDisplay() {
        ...
        return mMediaProjection.createVirtualDisplay("screenrecording", mScreenWidth, mScreenHeight, mScreenDensity, DisplayManager.VIRTUAL_DISPLAY_FLAG_AUTO_MIRROR, mMediaRecorder.getSurface(), null, null);
    }
